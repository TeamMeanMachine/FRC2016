...
public class ColorSensor {
	...
	private boolean tcs34725IntegrationTime;
	private boolean tcs34725Gain;
	...
	public byte read8(int regAddr) {
		...
		i2c.read(TCS34725_COMMAND_BIT | regAddr, 1, rxBuffer);
		return rxBuffer[0];
	}
	
	public short read16(int regAddr) {
		byte[] rxBuffer = new byte[2];
		i2c.read(TCS34725_COMMAND_BIT | regAddr, 2, rxBuffer);
